...
### uma ação específica. (Adicionado neste teste o reconhecimento de objetos da cor amarela)
...
def bateria():
	"""Verifica o nivel de bateria do Drone
	"""
...
while(1):
	...
	if (ids == 0):
		...
		while True:
			img = cv2.resize(imagem.frame, (width, height))
			imgContour = img.copy()
			...
			if tello.send_rc_control:
				...
				#final_image = cv2.resize(stack, 1000, 1000) 
